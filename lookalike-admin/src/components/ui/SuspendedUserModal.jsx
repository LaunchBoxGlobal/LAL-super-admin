    ...
    <main className="w-full min-h-screen flex items-center justify-center fixed inset-0 z-50 bg-[rgba(0,0,0,0.3)] px-4">
      <div className="w-full max-w-[471px] p-6 lg:p-6 rounded-[32px] relative overflow-hidden bg-white">
        ...
        <div className="w-full z-10 relative">
          ...
          <div className="w-full bg-white rounded-[12px] py-3 px-4 mt-2 max-h-[200px] overflow-y-auto">
            <p className="text-sm leading-[1.4]">{report?.reason}</p>
          </div>
          <h4 className="text-sm font-semibold mt-2">Description</h4>
          <div className="w-full bg-white rounded-[12px] py-3 px-4 mt-2 max-h-[200px] overflow-y-auto">
            <p className="text-sm leading-[1.4]">{report?.description}</p>
          </div>
        </div>
                ...
                {report?.media?.map((img, i) => {
                  return (
                    <img
                      ...
                      className="max-h-[45px] max-w-[45px] object-cover w-[45px] h-[45px] rounded-lg cursor-pointer"
                    />
                  );
                })}
              </div>

    ...
    <div className="min-h-screen  selection:bg-brand-100 selection:text-brand-900">
      ...
      <div className="w-full relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-48 pb-10">
        ...
        <div className="w-full">
          ...
          <p>
            By accessing and placing an order with LookAlike Match, you confirm
            ...
            communication between you and LookAlike Match.
          </p>
          <p>
            Under no circumstances shall LookAlike Match team be liable for any
            ...
            even if LookAlike Match team or an authorized representative has
          ...
          <p>
            LookAlike Match will not be responsible for any outcome that may
          ...
          <p>
            LookAlike Match grants you a revocable, non-exclusive,
          ...
          <p>
            These Terms & Conditions are a contract between you and LookAlike
            Match (referred to in these Terms & Conditions as "LookAlike Match",
            "us", "we" or "our"), the provider of the LookAlike Match website
            and the services accessible from the LookAlike Match website (which
            are collectively referred to in these Terms & Conditions as the
            "LookAlike Match Service").
          </p>
          <p>
            ...
            LookAlike Match Service. In these Terms & Conditions, "you" refers
          ...
          <ul className="space-y-2 mt-2">
            ...
            <li>
              ...
              “us,” or “our,” it refers to LookAlike Match LLC, (5204 Mitchell
              St. Alexandria, VA 22312), that is responsible for your
              information under this Terms & Conditions.
            </li>
            <li>
              <strong>Country:</strong> where LookAlike Match or the
              owners/founders of LookAlike Match are based, in this case is
              United States
            </li>
            <li>
              ...
              visit LookAlike Match and use the services.
            </li>
            <li>
              <strong>Service:</strong> refers to the service provided by
              LookAlike Match as described in the relative terms (if available)
            ...
            <li>
              ...
              LookAlike Match to use the Services.
            </li>
          </ul>
          ...
          <ul className="space-y-2 mt-2">
            <li>
              ...
              exploit the website/app or make the platform available to any
              third party.
            </li>
            <li>
            ...
            <li>
              ...
              (including any notice of copyright or trademark) of LookAlike
              Match or its affiliates, partners, suppliers or the licensors of
              the website/app.
            </li>
          </ul>
          ...
          <p>
            ...
            Provider. By providing LookAlike Match with your credit card number
            and associated payment information, you agree that LookAlike Match
            is authorized to verify information immediately, and subsequently
            invoice your account for all fees and charges due and payable to
            LookAlike Match hereunder and that no additional notice or consent
            is required. You agree to immediately notify LookAlike Match of any
            change in your billing address or the credit card used for payment
            hereunder. LookAlike Match reserves the right at any time to change
            its prices and billing methods, either immediately upon posting on
            our Site or by e-mail delivery to your organization’s
            administrator(s).
          </p>
          <p>
          ...
          <p>
            No contract will exist between you and LookAlike Match for the
            Service until LookAlike Match accepts your order by a confirmatory
          ...
          <p>
            Thanks for shopping at LookAlike Match. We appreciate the fact that
          ...
          <p>
            ...
            apply to transactions at LookAlike Match. We’ll be as brief as our
            attorneys will allow. The main thing to remember is that by placing
            an order or making a purchase at LookAlike Match, you agree to the
            terms along with LookAlike Match’s Privacy Policy.
          </p>
          <p>
          ...
          <p>
            ...
            (collectively, "Suggestions") provided by you to LookAlike Match
            with respect to the website/app shall remain the sole and exclusive
            property of LookAlike Match.
          </p>
          <p>
            LookAlike Match shall be free to use, copy, modify, publish, or
          ...
          <p>
            ...
            LookAlike Match. We are not responsible for the content, accuracy or
          ...
          <p>
            LookAlike Match uses "Cookies" to identify the areas of our
          ...
          <p>
            You acknowledge and agree that LookAlike Match may stop (permanently
            or temporarily) providing the Service (or any features within the
            Service) to you or to users generally at LookAlike Match’s sole
            discretion, without prior notice to you. You may stop using the
            Service at any time. You do not need to specifically inform
            LookAlike Match when you stop using the Service. You acknowledge and
            agree that if LookAlike Match disables access to your account, you
          ...
          <p>
            LookAlike Match reserves the right to modify, suspend or
          ...
          <p>
            LookAlike Match may from time to time provide enhancements or
          ...
          <p>
            ...
            of the website/app. You agree that LookAlike Match has no obligation
            to (i) provide any Updates, or (ii) continue to provide or enable
            any particular features and/or functionalities of the website/app to
            you.
          </p>
          <p>
          ...
          <p>
            You acknowledge and agree that LookAlike Match shall not be
            ...
            decency, quality or any other aspect thereof. LookAlike Match does
          ...
          <p>
            LookAlike Match may, in its sole discretion, at any time and for any
          ...
          <p>
            ...
            LookAlike Match, in the event that you fail to comply with any
          ...
          <p>
            Termination of this Agreement will not limit any of LookAlike
            Match's rights or remedies at law or in equity in case of breach by
          ...
          <p>
            You agree to indemnify and hold LookAlike Match and its parents,
          ...
          <p>
            ...
            maximum extent permitted under applicable law, LookAlike Match, on
            ...
            limitation to the foregoing, LookAlike Match provides no warranty or
          ...
          <p>
            Without limiting the foregoing, neither LookAlike Match nor any
            LookAlike Match's provider makes any representation or warranty of
            any kind, express or implied: (i) as to the operation or
            availability of the website/app, or the information, content, and
            materials or products included thereon; (ii) that the website/app
            will be uninterrupted or error-free; (iii) as to the accuracy,
            reliability, or currency of any information or content provided
            through the website/app; or (iv) that the website/app, its servers,
            the content, or e-mails sent from or on behalf of LookAlike Match
          ...
          <p>
            ...
            liability of LookAlike Match and any of its suppliers under any
          ...
          <p>
            ...
            LookAlike Match or its suppliers be liable for any special,
            ...
            Agreement), even if LookAlike Match or any supplier has been advised
            of the possibility of such damages and even if the remedy fails of
          ...
          <p>
            ...
            notices published by LookAlike Match on the Services, shall
            constitute the entire agreement between you and LookAlike Match
            ...
            LookAlike Match’s failure to assert any right or provision under
            this Agreement shall not constitute a waiver of such right or
            provision. YOU AND LookAlike Match AGREE THAT ANY CAUSE OF ACTION
          ...
          <p>
            LookAlike Match reserves the right, at its sole discretion, to
          ...
          <p>
            ...
            LookAlike Match regarding your use of the website/app and supersedes
          ...
          <p>
            ...
            when you use or purchase other LookAlike Match's services, which
            LookAlike Match will provide to you at the time of such use or
            purchase.
          </p>
          ...
          <p>
            ...
            arrangement thereof), are owned by LookAlike Match, its licensors or
            ...
            permission of LookAlike Match, unless and except as is expressly
          ...
          <p>
            ...
            REGARDING THE ENFORCEMENT OR VALIDITY OF YOUR OR LookAlike Match’s
            INTELLECTUAL PROPERTY RIGHTS. The term “dispute” means any dispute,
            action, or other controversy between you and LookAlike Match
          ...
          <p>
            In the event of a dispute, you or LookAlike Match must give the
            ...
            <strong>hello@theLookAlike Match.com</strong>. LookAlike Match will
            send any Notice of Dispute to you by mail to your address if we have
            it, or otherwise to your email address. You and LookAlike Match will
            ...
            sixty (60) days, you or LookAlike Match may commence arbitration.
          </p>
          ...
          <p>
            If you and LookAlike Match don’t resolve any dispute by informal
          ...
          <p>
            ...
            property of LookAlike Match without any compensation or credit to
            you whatsoever. LookAlike Match and its affiliates shall have no
          ...
          <p>
            LookAlike Match may, from time to time, include contests,
          ...
          <p>
            ...
            signed by an authorized representative of LookAlike Match. LookAlike
            Match will be entitled to injunctive or other equitable relief
            (without the obligations of posting any bond or surety) in the event
            of any breach or anticipatory breach by you. LookAlike Match
            operates and controls the LookAlike Match Service from its offices
            in United States. The Service is not intended for distribution to or
            ...
            Accordingly, those persons who choose to access the LookAlike Match
            ...
            include and incorporate the LookAlike Match Privacy Policy) contains
            the entire understanding, and supersedes all prior understandings,
            between you and LookAlike Match concerning its subject matter, and
          ...
          <p>
            LookAlike Match is not responsible for any content, code or any
            other imprecision. LookAlike Match does not provide warranties or
            guarantees.
          </p>
          <p>
            In no event shall LookAlike Match be liable for any special, direct,
          ...
          <p className="">
            The LookAlike Match Service and its contents are provided "as is"
            and "as available" without any warranty or representations of any
            kind, whether express or implied. LookAlike Match is a distributor
            and not a publisher of the content supplied by third parties; as
            such, LookAlike Match exercises no editorial control over such
            ...
            merchandise provided through or accessible via the LookAlike Match
            Service. Without limiting the foregoing, LookAlike Match
            specifically disclaims all warranties and representations in any
            content transmitted on or in connection with the LookAlike Match
            Service or on sites that may appear as links on the LookAlike Match
            Service, or in the products provided as a part of, or otherwise in
            connection with, the LookAlike Match Service, including without
            ...
            oral advice or written information given by LookAlike Match or any
            ...
            LookAlike Match does not warrant that the LookAlike Match Service
          ...
          <p>Via Email: hello@lookalikematch.com</p>
          <p>
            Via this Link:{" "}
            <a href="https://lookalikematch.com/contact">

    ...
    <div className="min-h-screen  selection:bg-brand-100 selection:text-brand-900">
      ...
      <div className="w-full relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-48 pb-10">
        ...
        <div className="w-full">
          <p className="">
            LookAlike Match (we, our, or us) is committed to protecting your
            privacy. This Privacy Policy explains how your personal information
            is collected, used, and disclosed by LookAlike Match.
          </p>
          <p className="mt-2">
            ...
            LookAlike Match. By accessing or using our Service, you signify that
          ...
          <ul className="space-y-2 mt-2">
            <li>
              ...
              amount of data generated by a website and saved by your web
            ...
            <li>
              <span className="font-semibold text-black">Company: </span>When
              this policy mentions “Company,” “we,” “us,” or “our,” it refers to
              LookAlike Match LLC, 5204 Mitchell St. Alexandria, VA 22312 that
              is responsible for your information under this Privacy Policy.
            </li>
            <li>
              <span className="font-semibold text-black">Country: </span>Where
              LookAlike Match or the owners/founders of LookAlike Match are
            ...
            <li>
              ...
              LookAlike Match Service to manage the relationships with your
            ...
            <li>
              ...
              other device that can be used to visit LookAlike Match and use the
              services.
            </li>
            <li>
              <span className="font-semibold text-black">IP address: </span>
            ...
            <li>
              <span className="font-semibold text-black">Personnel: </span>
              Refers to those individuals who are employed by LookAlike Match or
            ...
            <li>
              <span className="font-semibold text-black">Service: </span>Refers
              to the service provided by LookAlike Match as described in the
            ...
            <li>
              ...
              LookAlike Match's site, which can be accessed via this URL:{" "}
              <Link href={`https://www.lookalikematch.com`}>
                www.lookalikematch.com
              </Link>
            </li>
            <li>
              <span className="font-semibold text-black">You: </span>A person or
              entity that is registered with LookAlike Match to use the
              Services.
            </li>
          </ul>
          ...
          <h3 className="font-semibold text-xl mt-4 mb-2">
            When does LookAlike Match use end user information from third
            parties?
          </h3>
          <p className="">
            LookAlike Match will collect End User Data necessary to provide the
            LookAlike Match services to our customers.
          </p>
          <p className="">
          ...
          <h3 className="font-semibold text-xl mt-4 mb-2">
            When does LookAlike Match use customer information from third
            parties?
          </h3>
          <p className="">
            ...
            interest in becoming a LookAlike Match customer, we receive
            information from a third party that provides automated fraud
            detection services to LookAlike Match. We also occasionally collect
          ...
          <p className="">
            LookAlike Match will collect personal information that you submit to
          ...
          <p className="">
            ...
            LookAlike Match to you and fulfill the purposes described in this
          ...
          <p className="">
            ...
            information you transmit to LookAlike Match or guarantee that your
          ...
          <p className="">
            LookAlike Match is incorporated in United States. Information
          ...
          <h3 className="font-semibold text-xl mt-4 mb-2">
            Is the information collected through the LookAlike Match Service
            secure?
          </h3>
          <p className="">
          ...
          <p className="">
            ...
            information LookAlike Match collects depend on your relationship
            with LookAlike Match. Personnel may update or correct their
          ...
          <p className="">
            If you are a LookAlike Match worker or applicant, we collect
          ...
          <p className="">
            ...
            all of the assets of LookAlike Match or any of its Corporate
            Affiliates (as defined herein), or that portion of LookAlike Match
          ...
          <p className="">
            ...
            control with LookAlike Match, whether by ownership or otherwise. Any
          ...
          <p className="">
            ...
            laws of United States, excluding its conflicts of law rules, shall
            govern this Agreement and your use of the website/app. Your use of
            the website/app may also be subject to other local, state, national,
            or international laws. By using LookAlike Match or contacting us
            ...
            disclosure of your personal information will mean that you accept
            those changes.
          </p>
          ...
          <p className="">
            ...
            third party sites. LookAlike Match does not make any representation
            ...
            parties. Advertising keeps LookAlike Match and many of the websites
            and services you use free of charge. We work hard to make sure that
            ads are safe, unobtrusive, and as relevant as possible. Third party
            advertisements and links to other sites where goods or services are
            advertised are not endorsements or recommendations by LookAlike
            Match of the third party sites, goods or services. LookAlike Match
          ...
          <p className="">
            ...
            activity on the website/app and other online services to make online
          ...
          <p className="">
            LookAlike Match uses "Cookies" to identify the areas of our website
          ...
          <p className="">
            ...
            ("Third- Party Services"). You acknowledge and agree that LookAlike
            Match shall not be responsible for any Third-Party Services,
            ...
            thereof. LookAlike Match does not assume and shall not have any
          ...
          <p className="">
            ...
            the right thing to do. At LookAlike Match we strongly believe that
          ...
          <p className="">
            ...
            rights requirements of GDPR. LookAlike Match processes or stores all
            ...
            not hold it longer than 60 days. We are aware that if you are
            working with EU customers, you need to be able to provide them with
            the ability to access, update, retrieve and remove personal data. We
            got you! We've been set up as self service from the start and have
            always given you access to your data and your customers data. Our
            customer support team is here for you to answer any questions you
